...
!!! example "Installation commands"
    ...
    === "Linux"
        ...
        mkdir $installdir
        curl -L -o $installdir/wordslab-linux-x64.tar.gz https://github.com/wordslab-org/wordslab/releases/download/v0.8.1/wordslab-linux-x64.tar.gz
    ...
    === "macOS"
        ...
        installdir=$HOME/wordslab
        mkdir $installdir
        curl -L -o $installdir/wordslab-osx-x64.tar.gz https://github.com/wordslab-org/wordslab/releases/download/v0.8.1/wordslab-osx-x64.tar.gz
